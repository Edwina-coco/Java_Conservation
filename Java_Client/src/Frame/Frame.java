...
public class Frame extends JFrame {
	...
	public JButton set_userconfig; // 用户配置按钮
	public JButton set_connectconfig; // 连接配置按钮
	...
	public void init() {
		...
		set_userconfig = new JButton("用户信息");
		set_connectconfig = new JButton("连接信息");
		login = new JButton("登录");
		exit = new JButton("退出");
		exit.setEnabled(false);
		toolBar.add(set_userconfig);
		toolBar.add(set_connectconfig);
		...
		messagefield.setEnabled(false); // 不可用
